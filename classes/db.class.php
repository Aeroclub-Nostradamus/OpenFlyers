...
class DBAccessor
{
	...
	*/
	function connect()
	{
		$this->connID = mysqli_connect($this->host, $this->user, $this->password) OR die('Error: '.mysqli_error());
		mysqli_set_charset($this->connID,'latin1');
		mysqli_select_db($this->connID,$this->base) or die( 'Error: '.mysqli_error());
		$this->connected = true;
	}
	...
	*/
	function free()
	{
		if(($this->result!=null)and($this->result!=True))
		{
	...
	*/
	function query($query)
	{
		...
		$this->result=mysqli_query($this->connID,$query) OR die( 'Error: '.mysqli_error($this->connID));
		return($this->result);
	}	
   ...
   /**
	...
	function query_and_fetch_single($query)
	{
		...
		$this->result=mysqli_query($this->connID,$query) OR die( 'Error: '.mysqli_error());
