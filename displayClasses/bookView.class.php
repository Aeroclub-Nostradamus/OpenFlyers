...
class lineView
{
    ...
    function displayFreeSlot($current,$gap=1)
    {
        ...
        while ($gap>0) {
            ...
            $currentDate= clone $this->beginDate;
...
// displaying variables should be changed with XML use
    ...
    function SetLines()
    {
        ...
        for($i=0;$i<$this->days;$i++)
        {
            ...
            $begin->addSeconds(86400);  // 86400 = 24*60*60 REMOVED DUE TO DATE PROBLEM 
        }
    }
