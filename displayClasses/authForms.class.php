...
class authForms extends userSession
{
    ...
    function ask($langMessage)
	{
        ...
        ?><p class="annotation"> 
        <?php echo($lang['USERSESSION_COPYRIGHT']);?> Patrice GODARD, Patrick HUBSCHER, Christophe LARATTE, Soeren MAIRE<br />
        <?php echo($lang['USERSESSION_DOC_COPYRIGHT']);?> St&eacute;phane CROSES<br />
        <?php echo($lang['USERSESSION_SUP_COPYRIGHT']);?> Jean DE PARDIEU, Jo&euml;l TREMBLET<br />
        <?php echo($lang['USERSESSION_TM']);?><br />
        <a href="http://www.gnu.org/copyleft/gpl.html"><?php echo($lang['USERSESSION_GPL']);?></a>
        <br /><br /><a href="https://github.com/Aeroclub-Nostradamus/OpenFlyers">Portage PHP 7</a> : Vincent VIDELIER
        </p><?php
