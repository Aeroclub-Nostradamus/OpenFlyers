...
define ('MAIL_HOST','smtp.gmail.com');        // should be change : with localhost you don't send mail far away !
define ('MAIL_AUTH_NAME','ulm.lfne@gmail.com');           // if you have authentication with smtp fill this. Work only with smtp factory
define ('MAIL_AUTH_PASSWORD','Azerty12!');       // if you have authentication with smtp fill this. Work only with smtp factory
