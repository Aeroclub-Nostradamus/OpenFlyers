...
$onlyDate=clone $firstDisplayedDate;
...
$lastDisplayedDate=clone $firstDisplayedDate;

if($menu)
{
	$lastDisplayedDate->addSpan(new Date_Span('6 23:59:59')); //REMOVED DATE PROBLEM
...
if($type<>'EMPTY')
{
	//DATE PROBLEM IS LOCATED HERE => solved 07/08 VVI
